...
# import WebsiteFetch 
# from .models import WebsiteFetch, Cybersecurity_Reports, db
...
#                         response = {
#                             # "llama_response": llama_cyber_analyst(prompt=f"Do NOT include: ```json or ```   {agent_prompt}"), 
#                             # "deepseek_response": deepseek_cyber_analyst(prompt=f"Do NOT include: ```json or ```   {agent_prompt}"), 
...
#                         meta_data = gemma_agent_verifier(prompt=f"{agent_prompt} ")
...
#                         # Note: It is better to check by URL or Title for new articles, as 'id' usually doesn't exist yet.
#                         # Use .get() for safe dictionary access with defaults
                        
                        
#                         # print(f"saved_reports: {saved_report}")
